...
export const COMMANDS = [
    {
        ...
        description: "A paced, interactive tour. It seals a real record, verifies it, breaks it, " +
    ...
    },
    {
        ...
        description: "What this environment can currently prove. Shows the silicon and mode, the " +
    ...
    },
    {
        ...
        description: "Records a change to an AI system — a prompt edit, a model bump, a widened agent " +
    ...
    },
    {
        ...
        description: "Checks a receipt the way a stranger would: recompute the commitment, verify both " +
    ...
    },
    {
        ...
        description: "Filter and list sealed records. The questions this answers are the ones that come " +
    ...
    },
    {
        ...
        description: "Policy is evaluated inside the enclave and its verdict is sealed with the change, " +
    ...
    },
    {
        ...
        description: "A receipt commits to prompts and diffs as salted hashes, so it can be published. " +
    ...
    },
    {
        ...
        description: "A log signed only by its operator proves they have not contradicted themselves. A " +
    ...
    },
    {
        ...
        description: "One self-contained file with every receipt, the keys to check them, the pinned " +
    ...
    },
    {
        ...
        description: "Maps EU AI Act, DPDP, ISO 42001, SOC 2 and RBI clauses onto the receipt fields " +
    ...
    },
    {
        ...
        description: "Opens a folder, seeds a baseline from git so the first change is a real diff, and " +
    ...
    },
    {
        ...
        description: "Prints the attestation this environment can produce: quote format, root of trust, " +
    ...
    },
    {
        ...
        description: "Tree size, current root, the last signed tree head, and where the log lives on " +
    ...
    },
    {
        ...
        description: "What a platform team asks for: how many records, how many verify, how much the " +
    ...
    },
    {
        ...
        description: "Checks the registry and installs the newer release over the top. One command " +
    ...
    },
    {
        ...
        description: "Checks Node, WebCrypto, whether a dstack endpoint and a quote verifier are " +
    ...
    },
    {
        ...
        args: "[command|topic]",
        summary: "this manual",
        description: "With no argument, the command list and the concept index. With a command, its full " +
...
export const command = (name) => COMMANDS.find((c) => c.name === name);
export const topic = (name) => TOPICS.find((t) => t.name === name);
