 ...
 */
export function generateHybridSignature(payload, secretSeed = "veritas_hybrid_seed") {
 ...
 */
export function verifyHybridSignature(payload, signatureObj, secretSeed = "veritas_hybrid_seed") {
    const canonical = typeof payload === "string" ? payload : JSON.stringify(payload);
