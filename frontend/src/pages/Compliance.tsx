...
export default function Compliance() {
  ...
  return (
    <div className="max-w-6xl mx-auto py-8 px-4 animate-fade-in space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200/80 pb-6">
        ...
        <div className="flex flex-wrap sm:flex-nowrap items-center gap-3 w-full sm:w-auto">
          <button
            ...
            disabled={!reportData}
            className="flex-1 sm:flex-initial px-4 py-2 rounded-xl text-xs font-bold border border-slate-300 bg-white hover:bg-slate-50 text-slate-700 shadow-xs transition-colors flex items-center justify-center gap-2"
          >
            {copied ? (
              <>
          ...
          <button
            ...
            disabled={!reportData}
            className="flex-1 sm:flex-initial px-4 py-2 rounded-xl text-xs font-bold bg-slate-900 hover:bg-slate-800 text-white shadow-sm transition-colors flex items-center justify-center gap-2"
          >
        ...
        {Object.entries(frameworks).map(([key, meta]: [string, any]) => {
          ...
          return (
            <button
              ...
              className={`shrink-0 px-4 py-2.5 rounded-xl text-xs font-bold transition-all flex items-center gap-2 ${
                isActive
      ...
      <div className="bg-slate-900 text-slate-100 p-4 sm:p-6 rounded-2xl border border-slate-800 shadow-xl space-y-4 font-mono text-xs">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1 border-b border-slate-800 pb-3">
          ...
          <span className="text-slate-500 text-[10px] break-all sm:break-normal">
